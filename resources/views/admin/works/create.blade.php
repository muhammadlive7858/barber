...
<form action="{{ route('admin.works.store') }}" class="d-flex flex-direction-column align-center " method="POST" enctype="multipart/form-data">
    @method('post') @csrf   
    <div class="input-group">
        ...
        <input class="w-100 m-2 form-control" type="text" class="form-control" placeholder="Sartaroshning nomi" name="barber">
