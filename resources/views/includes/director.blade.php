...
<nav class="navbar navbar-expand-lg navbar-light bg-white container col-md-12">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Director Dashbord</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link m-2 color-white btn btn-outline-primary" aria-current="page" href="{{ route('admin.users.index') }}">Users</a>
        </li>
    </div>
  </div>
</nav>