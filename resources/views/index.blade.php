  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="barber-shop" class="nav-link">Barber Shop</a></li>
                  <li><a href="about" class="nav-link">About</a></li>
                  <li><a href="contact" class="nav-link">Contact</a></li>
                  <li><a href="login" class="nav-link">Admin panel</a></li>
                </ul>
              </nav>
            </div>
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('images/hero_1.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
              <h1 class="mb-3">Sartaroshlik bu soch kesish san'ati</h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta veritatis in tenetur doloremque, maiores doloribus officia iste. Dolores.</p>
              <p><a href="#" class="btn btn-primary">Batafsil ma'lumot</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto pl-lg-5 text-center">
            <h3 class="scissors text-center">Welcome To Barber!</h3>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="nonloop-block-13 owl-carousel d-flex">
              ...
              <div class="item-1 h" style="height:500px">
                <div class="item-1-contents">
                <img src="{{$work->image}}" alt="Image" class="img-fluid" style="width:300px">
                  <h3>{{$work->name}}</h3>
                  <ul>
                    <li class="d-flex"><span>Barber name</span> <span class="price ml-auto">{{$work->barber}}</span></li>
                    <li class="d-flex"><span>Description</span><span class="price ml-auto">{{$work->desc}}</span></li>
                    <li class="d-flex"><span>Name</span><span class="price ml-auto">{{$work->name}}</span></li>
                  </ul>
                </div>
              ...
              <div class="item-1 h">
                <div class="item-1-contents">
                  <h3>Hozircha Ishlanmalar mavjud emas</h3>
                </div>
              </div>
              @endforelse
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row hair-style d-flex">
        @forelse($stills as $still)
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="#" class="place">
              <img src="{{$still->image}}" alt="Image placeholder">
              <h2>{{$still->name}}</h2>
              <span>{{$still->desc}}</span>
              <span>{{$still->price}}</span>
            </a>
          </div>
          @empty
          <div class="row hair-style">
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <h1>Hozircha Stillar mavjud emas</h1>
            @endforelse
          </div>
    ...
    <div class="site-section bg-white">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-7 text-center mb-5">
            <h2 class="scissors text-center">Bizning Sartaroshlar</h2>
            <p>Bizning sartaroshlar 5-yillik tajribaga ega va shu bilan birga chet elda tajriba almashganligi bilan ajralib turadi</p>
          </div>
        </div>
