  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="barber-shop" class="nav-link">Barber Shop</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h3 class="scissors text-center">Bizning Sartaroshlarimiz</h3>
            <p class="mb-5 lead">Katta tajribaga ega sartarosh xizmatidan foydalaning</p>
          </div>
        </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row justify-content-center  mb-5">
          <div class="col-md-7 text-center">
            <h3 class="scissors text-center">Still turlari</h3>
            <p class="mb-5 lead">Sochingiz ishonchli qo'llarda</p>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="post-entry-1 h-100">
              <a>
                <img src="{{ $still->image }}" style="width: 300px;">
              </a>
              <div class="post-entry-1-contents">
